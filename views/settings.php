...
<table class="form-table">
	...
	<tr valign="top">
		<th scope="row"></th>
		<td><p class="description"><?php esc_html_e( 'Available variables:' ,'mailster-google-analytics' ); ?><br>%%CAMP_ID%%, %%CAMP_TITLE%%, %%CAMP_TYPE%%, %%CAMP_LINK%%,<br>%%SUBSCRIBER_ID%%, %%SUBSCRIBER_EMAIL%%, %%SUBSCRIBER_HASH%%,<br>%%LINK%%</p></td>
	</tr>
	<tr valign="top">
